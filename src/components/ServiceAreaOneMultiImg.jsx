        ...
        <div className="row gy-4 justify-content-center">
            ...
            <div className="service-card style-shadow">
              <div className="service-card_content">
                <div className="service-card_icon">
                  <img src="assets/img/icon/service-icon_1-1.svg" alt="sme2d" />
                </div>
                <h4 className="service-card_title h5">
                  <Link to="/service-details">XXXXXXXXXXXXXXXX </Link>
                </h4>
          ...
          <div className="col-lg-4 col-md-6">
            <div className="service-card style-shadow">
              <div className="service-card_content">
                <div className="service-card_icon">
                  <img src="assets/img/icon/service-icon_1-2.svg" alt="sme2d" />
                </div>
                <h4 className="service-card_title h5">
                  <Link to="/service-details">XXXXXXXXXXXXXXXXXXXXX</Link>
                </h4>
                <p className="service-card_text">
                  A car repair is a service provided to fix any issues or
                  damages with your{" "}
          ...
          <div className="col-lg-4 col-md-6">
            <div className="service-card style-shadow">
              <div className="service-card_content">
                ...
                <h4 className="service-card_title h5">
                  <Link to="/service-details">XXXXXXXXXXXXXXXXXXXX</Link>
                </h4>
                <p className="service-card_text">
                  A car repair is a service provided to fix any issues or
                  damages with your{" "}
          ...
          <div className="col-lg-4 col-md-6">
            <div className="service-card style-shadow">
              <div className="service-card_content">
                <div className="service-card_icon">
                  <img src="assets/img/icon/service-icon_1-4.svg" alt="sme2d" />
                </div>
                <h4 className="service-card_title h5">
              ...
              <div className="service-card_img">
                <img src="assets/img/service/service-1-4.png" alt="sme2d" />
              </div>
            </div>
          </div>
          <div className="col-lg-4 col-md-6">
            <div className="service-card style-shadow">
              <div className="service-card_content">
                <div className="service-card_icon">
                  <img src="assets/img/icon/service-icon_1-5.svg" alt="sme2d" />
                </div>
                <h4 className="service-card_title h5">
              ...
              <div className="service-card_img">
                <img src="assets/img/service/service-1-5.png" alt="sme2d" />
              </div>
            </div>
          </div>
          <div className="col-lg-4 col-md-6">
            <div className="service-card style-shadow">
              <div className="service-card_content">
                <div className="service-card_icon">
                  <img src="assets/img/icon/service-icon_1-6.svg" alt="sme2d" />
                </div>
                <h4 className="service-card_title h5">
              ...
              <div className="service-card_img">
                <img src="assets/img/service/service-1-6.png" alt="sme2d" />
              </div>
            </div>
          </div>
        </div>
