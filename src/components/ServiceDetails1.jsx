          ...
          <div className="col-xxl-8 col-lg-7">
            <div className="service-page-single">
              ...
              <div className="page-content">
                <h2 className="page-title">Relevage et Pompage des Eaux</h2>
                <p className="mb-25">
                  XXXXXXX
                  SME2D propose des solutions globales pour l’épuration et la réutilisation 
                  des eaux usées. Nos systèmes s’adaptent aux besoins des secteurs domestique,
                  industriel, agroalimentaire, pharmaceutique, textile, ou encore des abattoirs.
                  {" "}
                </p>
                <p className="mb-25">
