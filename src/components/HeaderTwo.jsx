          ...
          <div className="container">
            <div className="row align-items-center justify-content-between">
              <div className="col-auto header-navbar-logo">
                <div className="header-logo">
                  <Link href="/">
                    {/* <img src="assets/img/Design sans titre (33).png" alt="sme2d" /> badli smiya d la photo */}
                  </Link>
                </div>
              </div>
              <div className="col-auto">
                <nav className="main-menu d-none d-lg-inline-block">
                  <ul>
                    ...
                    <li className="menu-item-has-children">
                      ...
                      <ul className="sub-menu">
                        <li>
                          <Link href="/service">Nos services</Link>{/* service */}
                        </li>
                        <li>
                          <Link href="/service-details">Service Details</Link>{/* /service-details */}
                        </li>
                      </ul>
                    </li>
                    {/*
                    ...
                    */}
                    <li className="menu-item-has-children">
                      ...
                      <ul className="sub-menu">
                        ...
                        <li>
                          <Link href="#">Blog Details</Link>{/* /blog-details */}
                        </li>
                      </ul>
                    </li>
                    {/*
