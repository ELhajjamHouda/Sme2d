              ...
              >
                <SwiperSlide>
                  <div>
                    <div className="client-logo">
                      <Link href="#">
                        <img src="assets/img/client/1.png" alt="sme2d" />
                      </Link>
                    </div>
                  </div>
                </SwiperSlide>
                <SwiperSlide>
                  <div>
                    <div className="client-logo">
                      <Link href="#">
                        <img src="assets/img/client/2.png" alt="sme2d" />
                      </Link>
                    </div>
                  </div>
                </SwiperSlide>
                <SwiperSlide>
                  <div>
                    <div className="client-logo">
                      <Link href="#">
                        <img src="assets/img/client/3.png" alt="sme2d" />
                      </Link>
                    </div>
                  </div>
                </SwiperSlide>
                <SwiperSlide>
                  <div>
                    <div className="client-logo">
                      <Link href="#">
                        <img src="assets/img/client/4.png" alt="sme2d" />
                      </Link>
                    </div>
                  </div>
                </SwiperSlide>
                <SwiperSlide>
                  <div>
                    <div className="client-logo">
                      <Link href="#">
                        <img src="assets/img/client/5.png" alt="sme2d" />
                      </Link>
                    </div>
                  </div>
                </SwiperSlide>
