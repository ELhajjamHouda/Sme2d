          ...
          <div className="col-xxl-7 col-xl-6">
            <div className="about-thumb2 mb-40 mb-xl-0">
              ...
              <div className="about-img-2">
                <img src="assets/img/normal/about_2-2.png" alt="sme2d" />
              </div>
          ...
          <div className="col-xxl-5 col-xl-6">
            <div className="about-content-wrap">
              ...
              <div className="about-feature-wrap">
                <div className="icon">
                  <img src="assets/img/icon/about_icon2-3.svg" alt="sme2d" />
                </div>
              ...
              <div className="about-feature-wrap">
                <div className="icon">
                  <img src="assets/img/icon/about_icon2-4.svg" alt="sme2d" />
                </div>
                <div className="about-feature-wrap-details">
