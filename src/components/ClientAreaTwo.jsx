            ...
            >
              <SwiperSlide>
                <div>
                  <div className="client-logo">
                    <Link href="/">
                      <img src="assets/img/client/1-1.png" alt="sme2d" />
                    </Link>
                  </div>
                </div>
              </SwiperSlide>
              <SwiperSlide>
                <div>
                  <div className="client-logo">
                    <Link href="/">
                      <img src="assets/img/client/1-2.png" alt="sme2d" />
                    </Link>
                  </div>
                </div>
              </SwiperSlide>
              <SwiperSlide>
                <div>
                  <div className="client-logo">
                    <Link href="/">
                      <img src="assets/img/client/1-3.png" alt="sme2d" />
                    </Link>
                  </div>
                </div>
              </SwiperSlide>
              <SwiperSlide>
                <div>
                  <div className="client-logo">
                    <Link href="/">
                      <img src="assets/img/client/1-4.png" alt="sme2d" />
                    </Link>
                  </div>
                </div>
              </SwiperSlide>
              <SwiperSlide>
                <div>
                  <div className="client-logo">
                    <Link href="/">
                      <img src="assets/img/client/1-5.png" alt="sme2d" />
                    </Link>
                  </div>
                </div>
              </SwiperSlide>
            ...
            <div className="col-lg-7">
              <div className="testiomonial-wrap-2 bg-title">
                <div className="title-area">
                  <span className="sub-title">XXXXXXX</span>
                  <h2 className="sec-title text-white">WHAT OUR CLIENT SAYS</h2>
                </div>
                <div className="quote-icon">
                  <img src="assets/img/icon/quote2-1.svg" alt="sme2d" />
                </div>
